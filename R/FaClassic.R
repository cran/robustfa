...
FaClassic.formula <- function (formula, data = NULL, factors = 2, method = "mle", scoresMethod = "none", ...)
...
FaClassic.default <- function(x, factors=2, method = c("mle", "pca", "pfa"), scoresMethod = c("none", "regression", "Bartlett"), ...)
{
    cl <- match.call()
